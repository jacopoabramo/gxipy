...
class GxPixelFormatEntry:
    ...
    COORD3D_C16I16 = (
        GX_PIXEL_MONO | GX_PIXEL_16BIT | 0xFF02
    )  # 0x0110FF02 custom 3d pixel foramt
    COORD3D_C16S16 = (
        GX_PIXEL_MONO | GX_PIXEL_16BIT | 0xFF03
    )  # 0x0110FF03 custom 3d pixel foramt
    COORD3D_C16I16S16 = (
        GX_PIXEL_MONO | GX_PIXEL_16BIT | 0xFF04
    )  # 0x0110FF04 custom 3d pixel foramt
...
class GxSensorShutterModeEntry:
    ...
    GLOBALRESET = (
        2  # All pixels start exposure at same time, but exposure time are different
    )
