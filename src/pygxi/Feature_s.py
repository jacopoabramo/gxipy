...
class IntFeature_s(Feature_s):
    ...
    def __range_dicts(self, feature_value):
        ...
        range_dicts = {
            ...
            "reserved": gx.array_decoding(feature_value.reserved),
        }
        return range_dicts
            ...
            enum_dict.append(
                {
                    ...
                    "symbolic": gx.string_decoding(
                        feature_value.supported_value[index].cur_symbolic
                    ),
                }
            )
        return enum_dict
...
class FloatFeature_s(Feature_s):
    ...
    def __range_dict(self, feature_value):
        ...
        range_dicts = {
            ...
            "unit": gx.string_decoding(feature_value.unit),
            "reserved": gx.array_decoding(feature_value.reserved),
        }
        return range_dicts
    ...
    def set_buffer(self, buf):
        ...
        if buf.get_length() > max_length:
            print(
                ...
                % (self.__feature_name, max_length)
            )

            raise UnexpectedError(
                "buff length out of bounds, %s.length_max:%d"
                % (self.__feature_name, max_length)
            )
